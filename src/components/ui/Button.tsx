...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-red-700 to-red-900 text-white hover:from-red-800 hover:to-red-950 focus:ring-red-500 shadow-sm border border-red-700/50',
  ...
  return (
    <motion.button
      whileHover={!disabled && !isLoading ? { y: -1, transition: { duration: 0.1 } } : {}}
